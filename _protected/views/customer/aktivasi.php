...
$this->title = 'Bulk Aktivasi Status Mahasiswa ';
...
<div class="row">
    ...
    <div class="form-group">
        ...
        <?= Html::submitButton(' <i class="ace-icon fa fa-check bigger-110"></i>Aktifkan', ['class' => 'btn btn-info','id'=>'generate','value'=>1]) ?>    
        </div>
...
$(document).on('click','#generate',function(e){
    ...
    $.ajax({
        ...
        url : '".Url::to(['/customer/get-jumlah-mahasiswa-per-prodi'])."',
        beforeSend : function(){
        },
        error : function(err){
            console.log(err);
        ...
        success : function(data){
            ...
            Swal.fire({
              ...
              text: 'Jumlah Mahasiswa yang akan diaktifkan ada '+data.jumlah+' orang. Setujui Aktivasi ini?',
              icon: 'info',
